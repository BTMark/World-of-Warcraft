...
MOD.conditionTests = {
	...
	["Pet Status"] = { enable = false, exists = nil, inCombat = nil, checkTarget = nil, checkHealth = nil, minHealth = 100, checkPower = nil, minPower = 100 },
...
function MOD:UpdateConditions()
	...
	if not stat.noTarget then
		...
		m = UnitHealthMax("target"); if m > 0 then stat.targetHealth = (100 * UnitHealth("target") / m) else stat.targetHealth = 0 end
