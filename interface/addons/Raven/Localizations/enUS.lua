...
L["If checked, when icons mostly overlap, switch which is shown on top (otherwise always show icon with shortest time remaining on top)."] = true
L["Switch Time"] = true
L["Set time between switching mostly overlapping icons."] = true
L["Hide Empty"] = true
