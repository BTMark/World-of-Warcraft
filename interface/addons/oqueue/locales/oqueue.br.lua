...
OQ.SETUP_GARBAGE    = "garbage collect (intervalo de 5 sec)" ;
...
OQ.SAPPED           = "{skull}  Levei Sap  {skull}" ;
...
OQSYS_YOUARE_AFK    = "Você está Ausente" ;
OQSYS_YOUARENOT_AFK = "Você não está mais ausente" ;
